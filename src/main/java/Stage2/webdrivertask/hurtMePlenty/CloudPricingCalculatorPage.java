...
public class CloudPricingCalculatorPage extends AbstractPage {
    ...
    public String getProvisioningModel() {
        return new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.presenceOfElementLocated(PROVISIONING_MODEL_AREA)).getText();
    }

    public String getInstanceType() {
        return new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.presenceOfElementLocated(INSTANCE_TYPE_AREA)).getText();
    }

    public String getRegion() {
        return new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.presenceOfElementLocated(REGION_AREA)).getText();
    }

    public String getLocalSSDValue() {
        return new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.presenceOfElementLocated(SSD_AREA)).getText();
    }

    public String getTermAreaValue() {
        return new WebDriverWait(driver, Duration.ofSeconds(10))
                .until(ExpectedConditions.presenceOfElementLocated(TERM_AREA)).getText();
    }
